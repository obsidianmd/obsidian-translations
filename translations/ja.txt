...
translation=シークレットIDが無効です。小文字、数字、ハイフンのみ使用できます（最大64文字）。
...
translation=シークレットはまだ追加されていません。シークレットは、プラグインが使用できるAPIキーやパスワードなどの情報を保存するために使われます。

[setting.keychain.label-select-secret]
original=Select secret
translation=シークレットを選択

[setting.keychain.placeholder-search-secret]
original=Find secret...
translation=シークレットを検索…
...
translation=このシステムで利用可能なシークレットストアがないため、シークレットは暗号化せずに保存されます。

[setting.keychain.msg-secrets-not-encrypted-short]
original=Secrets are not encrypted
translation=シークレットは暗号化されていません
...
translation=暗号化はお使いのオペレーティングシステムのシークレットストアによって提供されます。シークレットストアがない場合、シークレットは暗号化せずに保存されます。

[setting.keychain.msg-linux-secret-stores]
original=On Linux, supported secret stores include:
translation=Linux でサポートされているシークレットストアには以下が含まれます:

[setting.about.name]
original=General
translation=Obsidianについて
...
translation=インストーラーのバージョン: {{version}}
...
translation=最新機能のサポートと最新のセキュリティパッチを受け取るためには Obsidian インストーラーのメジャーアップデートが必要となります。新しい Obsidian を手動ダウンロードした上で再インストールしてください。

[setting.about.label-new-version-ready]
original=A new version is ready to be installed. 
translation=最新バージョンがインストールできます。

[setting.about.label-disabled-updates]
original=Updates are disabled.
translation=更新は無効になっています。
...
translation=アプリが遅く読み込まれる原因を確認することで、問題を診断します。
...
translation=PATH に "obsidian" を登録し、ターミナルのどこからでも "obsidian" コマンドにアクセスできるようにします。
...
translation=Obsidianを使うためのヘルプを取得します。
...
translation=新機能を試すにはインサイダービルドへの自動更新を有効にしてください。ビルドは最先端のものであり、不安定である可能性があります。
...
translation=現在、カタリストライセンスを所持していません。カタリストライセンスはObsidianの開発をサポートする買い切り版のワンタイムドネーションです。
...
translation=Obsidianへの言語の追加方法を閲覧
...
translation=現在、次のアカウントでサインインしています: {{name}} ({{email}})。
...
translation=あなたは現在ログインしていません。アカウントはObsidian Sync、Obsidian Publish、およびカタリストインサイダービルドにのみ必要となります。
...
translation=Obsidianを100%ユーザー支援で維持するための支援です。
...
translation=制限モードが無効になっています。コミュニティプラグインを無効化するにはこの設定を有効にしてください。
...
translation=最高のコミュニティによって開発されたサードパーティプラグインを閲覧してインストールします。
...
translation=コミュニティプラグインは、インストールした他のソフトウェアのように、潜在的にデータ完全性やセキュリティ上の問題を引き起こす可能性があります。
...
translation=プラグインセキュリティは私達にとって重要なものであるため、以下の事柄を実行しています。
...
translation=努力に関わらず、コミュニティプラグインが不正を行う可能性が依然としてわずかに存在しています。

[setting.third-party-plugin.label-code-review]
original=Initial code review
translation=初期コードレビュー
...
translation=プラグインはストアに登場する前に私達のチームによって初期コードレビューを受けます。
...
translation=大半のプラグインはGithub上でオープンソースとして公開されており、コードについてユーザー自身で検証することができます。

[setting.third-party-plugin.label-peer-audit]
original=Peer audit
translation=コミュニティによる監査
...
translation=お互いに目を配りあう大きな開発者コミュニティがあります。
...
translation=ユーザーの報告に応じて欠陥のあるプラグインについての追跡調査を行い、削除します。
...
translation=初めて開くこの保管庫にはいくつかのプラグインが含まれています。
...
translation=この保管庫が他人から入手されたものである場合には、開発元の不明なプラグインがセキュリティ上のリスクを引き起こす可能性があることに注意してください。
...
translation=コミュニティプラグインがロードできませんでした。

[setting.third-party-plugin.label-installed]
original=Installed
translation=インストール済み
...
translation= (現在のインストールバージョン: {{version}})
...
translation=インストール済みのプラグインを名前や説明でフィルターします。
...
translation=プラグイン開発者達は情熱から素晴らしいプラグインを開発しているコミュニティのボランティアです。このプラグインが役立つと感じた場合には開発を支援することを検討してください。
...
translation=画面上からプルダウンしたときに起動するコマンドを設定します。現在のコマンドは "{{command}}" に設定されています。

[setting.mobile-toolbar.msg-missing-quick-action]
original=Action not configured
translation=クイックアクションが見つかりません。
...
translation=脚注と参照を削除

[editor.menu.reset-size]
original=Reset size
translation=サイズをリセット
...
translation="{{file}}" が外部で修正されています。自動的に変更をマージします。
...
translation=iOS をロックダウンモードで使用している場合は、ロックダウンモードの "Webブラウジングを構成" 設定から Obsidian を除外してください。

[interface.label-enter-to-create]
original=Enter to create
translation=Enterキーで作成

[interface.label-update-available]
original=Update Available
translation=アップデートが利用可能
...
translation=まだ作成されていません、作成するには選択してください
...
translation=指定の場所に保管庫を作成できませんでした。もう一度場所と権限を確認してください。
...
translation=現在開いている保管庫は削除できません。
...
translation=Obsidian はノートをデバイス上に保存するため、オフラインでもすばやく、プライベートにアクセスできます。\nデータは **保管庫** と呼ばれる安全なローカルフォルダに保存されます。
...
translation=Obsidian はノートをデバイス上に保存するため、別のスマートフォンやコンピュータでノートにアクセスしたい場合は同期を設定する必要があります。\n今すぐ同期を設定することも、まず書き始めて後で設定することもできます。
...
translation=最も強力なセキュリティを提供しますが、暗号化パスワードを安全に保管する必要があります
...
translation=Obsidian が管理するキーを使用して、転送中および当社サーバー上のデータを保護します。
...
translation=このデバイスに同期する際に除外したいフォルダやファイルはありますか？
...
translation=Obsidian アカウントを作成するかサインイン
...
translation=近くのサーバーリージョンを選ぶと同期が速くなります。
...
translation=このパスワードは後から変更できません。パスワードを忘れると、Sync サーバー上のリモートデータには永久にアクセスできなくなります。
...
translation=Obsidianが公式にサポートしている同期方法は **Obsidian Sync** と **iCloud** の2つです。\nただし、Obsidianはデータを自分で管理できるため、他の同期オプションも利用できます。\nこれらのオプションには、サードパーティのプラグインや他のツールが含まれ、より高度な設定が必要になる場合があります。\n代替の同期方法を使用するには、**保管庫を作成**し、プラグインまたはサードパーティの同期プロバイダーが提供する手順に従ってください。
...
translation=まもなく **{{email}}** 宛てに、Obsidian Syncに接続するための手順が記載されたメールが届きます。
...
translation=iCloudの保管庫が検出されませんでした。原因として以下が考えられます：
...
translation=保管庫が、このデバイスで現在サインインしているものとは別のiCloudアカウント上にあります。
...
translation=保管庫がiCloud Drive内の最上位のObsidianフォルダに保存されていません。

[interface.start-screen.mobile.i-cloud-unsupported]
original=iCloud not supported
translation=iCloudはサポートされていません
...
translation=Obsidianを楽しんでいますか？評価をつけてご協力ください。
...
translation=iCloudから設定ファイルが更新されました。再読み込みが必要です
...
translation=Obsidian公式のヘルプドキュメントを読むことができます。ドキュメントは多言語での利用が可能です。
...
translation=Discord は世界中から集まる卓越した Obsidian ユーザーたちとチャットするためのベストな場所です。
...
translation=ユーザー同士の助け合いや機能リクエスト、バグレポート、ナレッジマネジメントについての議論などを行うことができます。

[interface.help-screen.label-sandbox-vault]
original=Sandbox vault
translation=サンドボックス保管庫
...
translation=このファイルにリンクしている内部リンクを更新しますが良いですか？
...
translation={{count}} 件のファイルをアップデートしました。
...
translation={{count}} 件のファイルへの変更を元に戻しました。
...
translation=これらの {{count}} 個の添付ファイルは、どのノートでも使用されなくなりました。削除しますか？
...
original=Export To PDF...
translation=PDFとしてエクスポート…

[menu-items.insert-attachment]
original=Insert Attachment...
translation=添付ファイルを挿入…
...
original=Folding
translation=メニューのフォールド

[menu-items.fold-all]
original=Fold All
translation=すべてフォールド

[menu-items.unfold-all]
original=Unfold All
translation=すべてのフォールドを解除
...
original=Left Sidebar
translation=左サイドバーに切り替える

[menu-items.toggle-right-sidebar]
original=Right Sidebar
translation=右サイドバーに切り替える
...
translation=添付ファイルは今後 "{{path}}" に保存されます。
...
original=Is true
translation=true である

[plugins.search.label-match-false]
original=Is false
translation=false である
...
translation=結果がクリップボードにコピーされました。
...
translation=Obsidian内で開くことのできないタイプのものを含むあらゆるファイルを表示するかどうかを決めます。そのタイプのファイルはデフォルトのアプリで開かれます。
...
translation=ノードを表示するためにリンクをたどる回数
...
translation=タグが含まれるファイルにリンクされます
...
translation=チェックすると、存在しないファイルへのリンクは表示しません
...
translation=他のファイルからリンクされていないファイルも表示
...
translation=現在のノートから脚注のリストを表示します。
...
translation=プロパティ "{{oldKey}}" を "{{newKey}}" に統合しますか？
...
translation=競合がある場合、値は統合されるか、"{{oldKey}}" の値が使用されます。
...
translation=検索、バックリンク、アウトゴーイングリンク
...
translation=ページプレビューを表示するには {{key}} キーを押しながらホバーします
...
translation=頻繁に使用、検索されるファイルをブックマークします。

[plugins.bookmarks.action-show]
original=Show bookmarks
translation=ブックマークを表示
...
translation=アクティブタブをブックマーク…

[plugins.bookmarks.action-new-group]
original=New group
translation=新規ブックマークグループ
...
translation=このテーマではREADMEファイルが提供されていません。
...
translation=フロントマターのタグ、エイリアス、cssclasses を、Obsidian v1.9+ で必要な厳密な形式に移行します
...
translation=警告: インポーターは現在のファイルだけでなく、保管庫内のすべてのファイルを変換します。
...
translation=ファイルは上書きされます。変換する前にすべてのファイルをバックアップしてください。
...
translation=デイリーノートを開きます。ファイルが存在しない場合には作成します。
...
translation=保管庫内でデイリーノートに付ける名前の形式を選択します。
...
translation=ZettelkastenやSlip boxといったワークフロー用にファイル名に一意なタイムスタンププレフィックスをつけてノートを作成できます。
...
translation=ランダムにノートを1つ開きます。振返りと発見に役立ちます。
...
translation=ステータスバーにワード数を表示します。
...
translation=このフォルダ内のファイルをテンプレートとして利用できるようになります。
...
translation=テンプレートファイルの {{date}} はこの値に置き換えられます。
...
translation={{date:YYYY-MM-DD}} を使用して、書式を上書きすることもできます。
...
translation=テンプレートファイルの {{time}} はこの値に置き換えられます。
...
translation={{time:HH:mm}} を使用して、書式を上書きすることもできます。
...
translation=あなたのサイトは https://publish.obsidian.md/{site id} です。これは後で変更できます。小文字、数字、ダッシュのみが使用できます。

[plugins.publish.option-site-id-placeholder]
original=Pick a site ID
translation=サイトIDを選択してください
...
translation=サイトのロゴとして使用する画像ファイルを選択してください。
...
translation=サイトナビゲーション内で特定のページを非表示にするには、右クリックを行い "隠す" を選択してください。非表示にしたページにはリンク経由やURLから直接アクセスできます。

[plugins.publish.option-show-hidden-items]
original=Show hidden
translation=非表示アイテムを表示
...
translation=パブリッシュサイト内で表示されるナビゲーションアイテムの順番をドラッグ＆ドロップでカスタマイズできます。
...
translation=サイトのデフォルトの配色を選択します。
...
translation=ライトテーマとダークテーマの切り替え
...
translation=サイト訪問者が自分でライトテーマとダークテーマを切り替えられるようにします。

[plugins.publish.option-show-navigation]
original=Show navigation
translation=ナビゲーションを表示
...
translation=公開サイトの左側に、公開されているすべてのページのリストを表示します。
...
translation=ページタイトルの見出しを非表示にします。各ページのはじめに独自の見出しがある場合に役立ちます。
...
translation=サイトにGoogleアナリティクスを設定します。Googleアナリティクスはカスタムドメインからの訪問者のみが利用できることに注意してください。まずは自身の居住する地域の法律と制限によって許可されていることを確認してください。
...
translation=現在のサイトに公開する権限がありません。
...
translation=現在、サイトにはパスワードが存在しません。誰でも閲覧することができる状態です。
...
translation=あなたのサイトはパスワードで保護されています。複数のパスワードを設定している場合には、訪問者はいずれかのパスワードを入力することでサイトにアクセスできます。
...
translation=サイトを閲覧するには、設定 -> コアプラグイン の項目からパブリッシュのコアプラグインを有効にしてください。
...
translation=共有されているサイトリストからこのサイトを取り除きます。このアクションは元に戻すことができません。
...
translation=このサイトとのコラボレーションを再開したい場合にはサイト所有者にコンタクトを取ってください。
...
translation=ライブバージョンが使用され、ローカルバージョンは破棄されます。必要な場合にはバックアップの作成をしてください。
...
translation=ローカルバージョンが正常に上書きされました。ライブバージョンを使用することができます。

[plugins.publish.label-open-in-live-site]
original=Open in live site
translation=ライブサイトで開く
...
translation=保管庫の用途を覚えやすい名前をつけてください。
...
translation=リモート保管庫を保存する、最も近いサーバーリージョンを選択してください。これは後から変更できません。
...
translation=エンドツーエンド暗号化は最も強力なセキュリティを提供しますが、暗号化パスワードを安全に保管する必要があります。標準の暗号化は、Obsidian が管理するキーを使用して、転送中およびサーバー上のデータを保護します。

[plugins.sync.option-encryption-warning]
original=This option cannot be changed later.
translation=このオプションは後から変更できません。
...
translation=リモート保管庫 “{{name}}” は現在暗号化されています。ロック解除するにはパスワードを入力してください。
...
translation=ファイル共有サービスでの競合が検知されました
...
translation=警告: この保管庫は {{service}} をサードパーティの共有サービスとして利用しているようです。この保管庫に対してObsidian Syncを利用すると、競合やファイル破損、データ損失の発生する可能性があります。
...
translation=iCloud Driveを使用している場合には、iCloudによってDocumentsとDesktopのフォルダが共有されている可能性があります。この設定はObsidian Syncとの競合を引き起こすことがあります。
...
translation=この名前は同期ログに表示されます。デフォルトの名前を使用する場合には空白のままにしてください。
...
translation=`復元が完了しました: {{succeeded}} が成功し、 {{failed}} が失敗しました。`
...
translation=これらは最もスペースを取っているリモートファイルです。添付ファイルを削除した後、リモート保管庫のスペース開放のためにパージボタンを使用してください。

[plugins.sync.button-upgrade-storage]
original=Upgrade storage
translation=ストレージをアップグレード
...
translation=未同期のファイルが残されている場合にデバイスがスリープするのを防ぎます。
...
translation=次の拡張子の画像ファイルを同期します: {{extensions}}。
...
translation=次の拡張子の音声ファイルを同期します: {{extensions}}。
...
translation=次の拡張子の動画ファイルを同期します: {{extensions}}。
...
translation=エディタ設定、ファイルとリンクの設定、カスタムホットキー等の同期を有効化します。
...
translation=ダークモード、アクティブテーマ、有効化されているスニペットなどの外観の設定を同期するかどうかを決めます。

[plugins.sync.option-sync-appearance-data]
original=Themes and snippets
translation=テーマとスニペット
...
translation=ダウンロードされたテーマとスニペットを同期するかどうかを決めます。有効化されているかどうかは外観の同期設定に依存します。
...
translation=インストールされているコミュニティプラグイン(.jsファイル、.cssファイルとmanifest.jsonファイル)とプラグイン設定を同期するかどうかを決めます。

[plugins.sync.label-sync-loading]
original=Sync is still loading, please refresh this page later.
translation=Sync はまだ読み込み中です。後でこのページを更新してください。
...
translation=Obsidian Syncはエンドツーエンド暗号化とバージョン履歴のためのアドオン同期サービスです。

[plugins.sync.label-account-required]
original=To start syncing, please log in or create a new Obsidian account.
translation=同期を開始するには、ログインするかObsidianの新規アカウントを作成してください。
...
translation=リモート保管庫 "{{name}}" に接続している場合には、ローカル保管庫内のノートはリモート保管庫からのノートと統合されます。競合が起きた場合には、最新バージョンのノートが維持されます。
...
translation=共有されている保管庫リストからこの保管庫を取り除きます。このアクションは元に戻すことができません。
...
translation=この保管庫とのコラボレーションを再開したい場合には保管庫所有者にコンタクトを取ってください。
...
translation=リモート保管庫の読み込みに失敗しました。
...
translation=この保管庫に接続するにはObsidian Syncのサブスクリプションが必要です。
...
translation=リモート保管庫を削除し、最新の暗号化で再作成します。ローカルファイルには影響しませんが、バージョン履歴は失われます。

[plugins.sync.label-confirm-migrate]
original=Confirm vault migration
translation=保管庫の移行を確認
...
translation=暗号化をアップグレードするには、保管庫内のすべてのデータを新しい暗号化方式で Obsidian Sync サーバーに再アップロードします。この処理により、保管庫のバージョン履歴を含む、古い暗号化で暗号化されたすべてのデータが永久に削除されます。
...
translation=重要: 予期しないデータ損失を防ぐため、続行する前に保管庫のバックアップを作成することを強く推奨します。
...
translation=アップグレードの完了後、更新されたリモート保管庫にすべてのデバイスを再接続する必要があります。
...
translation=保管庫の移行には時間がかかる場合があります。すべてのノートと添付ファイルを再アップロードするため、このデバイスで Obsidian をアクティブに保つ必要があります。メインのデバイスで行うのが最適です。
...
translation=複数のデバイスで同じノートが別々に変更された場合に、競合をどのように解決するかを選択します。
...
translation=すべてのスナップショットを削除します。
...
translation=統合や抽出の際に使用するテンプレートファイルを選択してください。利用可能な変数: {{content}}、{{fromTitle}}、{{newTitle}}、{{date:FORMAT}}, 例 {{date:YYYY-MM-DD}}。

[plugins.note-composer.command-merge-file]
original=Merge current file with another file...
translation=現在のファイルを別のファイルに統合…

[plugins.note-composer.action-merge-file]
original=Merge entire file with...
translation=ファイル全体を別ファイルに統合…
...
translation="{{file}}" を "{{destination}}" に統合しますか？ "{{file}}" は削除されます。
...
translation=外部リンクをObsidian内のWebページとして開きます。

[plugins.web-viewer.action-open]
original=Open web viewer
translation=Webビューアを開く
...
translation=値を小さくすることでパフォーマンスが向上しますが、ズームアウトで直ちにカード内容が隠れるようになります。
...
translation=値を大きくすることでより高解像の画像を生成します。
...
translation=キャンバス全体と現在表示中のビューポートのどちらをレンダーするか選択してください。
...
translation=Canvas は {{count}} 枚の埋め込みカードを更新しました
...
translation=プロパティを使ってファイルを編集・並べ替え・フィルターできるカスタムビューを作成します。
...
translation=テーマに合わせる

[pdf.label-page]
original=page {{page}}
translation=ページ {{page}}
...
translation={{oldType}} のデータは互換性がありません。新しい形式に合わせて適用されます。
